...
const ServiceID ServiceID_MIN = SID_BEGIN;
...
const LoginCmdID LoginCmdID_MIN = CID_LOGIN_BEGIN;
const LoginCmdID LoginCmdID_MAX = CID_LOGIN_RES_REGISTER;
...
const BuddyListCmdID BuddyListCmdID_MIN = CID_BUDDY_BEGIN;
...
const MessageCmdID MessageCmdID_MIN = CID_MSG_BEGIN;
...
const GroupCmdID GroupCmdID_MIN = CID_GROUP_BEGIN;
...
const FileCmdID FileCmdID_MIN = CID_FILE_BEGIN;
...
const SwitchServiceCmdID SwitchServiceCmdID_MIN = CID_SWITCH_BEGIN;
...
const OtherCmdID OtherCmdID_MIN = CID_OTHER_BEGIN;
...
const KickReasonType KickReasonType_MIN = KICK_BEGIN;
...
const OnlineListType OnlineListType_MIN = ONLINE_BEGIN;
...
const UserStatType UserStatType_MIN = USER_STATUS_BEGIN;
...
const SessionType SessionType_MIN = SESSION_TYPE_BEGIN;
...
const ClientType ClientType_MIN = CLIENT_BEGIN;
...
const GroupType GroupType_MIN = GROUP_TYPE_BEGIN;
...
const GroupModifyType GroupModifyType_MIN = GROUP_MODIFY_BEGIN;
...
const TransferFileType TransferFileType_MIN = FILE_TYPE_BEGIN;
...
const ClientFileRole ClientFileRole_MIN = CLIENT_REALTIME_BEGIN;
...
inline void UserInfo::set_password(::std::string&& value) {
  ...
  password_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:IM.BaseDefine.UserInfo.password)
}
#endif
...
inline ::std::string* UserInfo::release_password() {
  // @@protoc_insertion_point(field_release:IM.BaseDefine.UserInfo.password)
...
#if LANG_CXX11
inline void UserInfo::set_salt(::std::string&& value) {
  
  salt_.SetNoArena(
    &::google::protobuf::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
  // @@protoc_insertion_point(field_set_rvalue:IM.BaseDefine.UserInfo.salt)
}
#endif
...
inline ::std::string* UserInfo::release_salt() {
  // @@protoc_insertion_point(field_release:IM.BaseDefine.UserInfo.salt)
