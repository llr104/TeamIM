...
goog.provide('proto.IM.Message.IMUnreadMsgCntRsp');

goog.require('jspb.BinaryReader');
goog.require('jspb.BinaryWriter');
goog.require('jspb.Message');
goog.require('proto.IM.BaseDefine.UnreadInfo');
...
proto.IM.Message.IMUnreadMsgCntRsp.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.IM.BaseDefine.UnreadInfo.toObject, includeInstance),
...
proto.IM.Message.IMUnreadMsgCntRsp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.IM.BaseDefine.UnreadInfo;
      reader.readMessage(value,proto.IM.BaseDefine.UnreadInfo.deserializeBinaryFromReader);
...
proto.IM.Message.IMUnreadMsgCntRsp.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      3,
      f,
      proto.IM.BaseDefine.UnreadInfo.serializeBinaryToWriter
    );
  }
...
proto.IM.Message.IMUnreadMsgCntRsp.prototype.getUnreadinfoListList = function() {
  return /** @type{!Array.<!proto.IM.BaseDefine.UnreadInfo>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.IM.BaseDefine.UnreadInfo, 3));
};
