...
goog.provide('proto.IM.Buddy.IMUserStatNotify');
...
proto.IM.Buddy.IMUserStatNotify.toObject = function(includeInstance, msg) {
  var f, obj = {
    userStat: (f = msg.getUserStat()) && proto.IM.BaseDefine.UserStat.toObject(includeInstance, f)
  };
...
proto.IM.Buddy.IMUserStatNotify.prototype.getUserStat = function() {
  return /** @type{?proto.IM.BaseDefine.UserStat} */ (
    jspb.Message.getWrapperField(this, proto.IM.BaseDefine.UserStat, 1));
};
