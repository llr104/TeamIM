...
_IMFILEPULLDATAREQ.fields_by_name['trans_mode'].enum_type = IM_dot_BaseDefine__pb2._TRANSFERFILETYPE
_IMFILEREQ.fields_by_name['trans_mode'].enum_type = IM_dot_BaseDefine__pb2._TRANSFERFILETYPE
_IMFILERSP.fields_by_name['ip_addr_list'].message_type = IM_dot_BaseDefine__pb2._IPADDR
_IMFILERSP.fields_by_name['trans_mode'].enum_type = IM_dot_BaseDefine__pb2._TRANSFERFILETYPE
_IMFILENOTIFY.fields_by_name['ip_addr_list'].message_type = IM_dot_BaseDefine__pb2._IPADDR
_IMFILENOTIFY.fields_by_name['trans_mode'].enum_type = IM_dot_BaseDefine__pb2._TRANSFERFILETYPE
